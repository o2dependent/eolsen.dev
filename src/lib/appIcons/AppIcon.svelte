...
>
	...
	{:else}
		<div class="aspect-square h-full w-full rounded-full bg-black p-0.5">
			<svg
				width="100%"
				height="100%"
				viewBox="0 0 512 512"
			...
			>
				...
				<g mask="url(#mask0_9225_963)">
					...
					<rect x="77" y="69" width="357" height="55" fill="white" />
					<rect x="31" y="233" width="253" height="55" fill="white" />
				</g>
			</svg>
		</div>
	{/if}
