---
title: macOS Desktop
description: A crude clone of the macOS desktop.
pubDate: "Mar 21 2023"
...
The purpose of this project was to demonstrate my skills in creating a distinctive user interface using Svelte and Tailwind. I wanted to showcase my learning achievements by developing a crude version of the macOS operating system. As an macOS user, I appreciate its efficient app management system. My aim was to replicate the macOS look on a website and, more importantly, capture the overall experience of using an operating system.
