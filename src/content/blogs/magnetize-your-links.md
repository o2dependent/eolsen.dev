...
To get this effect I'll be using [GSAP](https://gsap.com/) and [Svelte](https://svelte.dev/). You'll be using it as a `use:` action on whichever element you want to magnetize. Below is `magneticHover` effect I use on this site.
