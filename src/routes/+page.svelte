...
<div class="h-full w-full bg-black font-roboto text-gray-50">
	<header class="flex w-full items-center justify-center">
		<nav class="container flex p-4">
			<div class="flex flex-grow items-center gap-2">
				<a class="flex items-center justify-center gap-2 text-2xl" href="/"
					><svg
						width="48"
						height="48"
						viewBox="0 0 48 48"
			...
			<div class="flex flex-grow items-center justify-end gap-2 text-lg">
				<a class="opacity-75 transition-all hover:opacity-100 active:scale-95" href="#about">
					About
				</a>
				<a class="opacity-75 transition-all hover:opacity-100 active:scale-95" href="#projects">
					Projects
				</a>
				<a
					class="rounded bg-white px-3 py-2 text-black opacity-75 transition-all hover:opacity-100 active:scale-95"
					href="/app/desktop"
				>
					Open Desktop
				</a>
	...
	<div class="h-full w-full pt-9">
		<div class="fly-up mx-auto w-fit px-4">
			<h1 class="rainbow mx-auto max-w-2xl bg-clip-text text-center text-6xl font-bold">
				Full-Stack Developer With <span class="text-transparent">Passion</span>
			</h1>
		</div>
		<div class="mx-auto mt-20 grid h-72 w-full max-w-2xl grid-cols-1 grid-rows-1 px-4">
			<div
		...
		<div
			style="padding-top: {terminalHeight ? terminalHeight - 200 : 350}px"
		...
		>
			...
			>
				...
				<div class="relative float-right my-2 mr-4 h-44 w-44">
					{#if isAboutVisible}
						<img
					...
					{/if}
					<img
						class="absolute left-0 top-0 m-0 h-44 w-44 rounded-xl object-cover ring-4 ring-gray-950"
						src={AboutPhoto}
